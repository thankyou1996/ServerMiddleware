...
namespace ServerMiddleware.SystemSet
{
    public class SystemSet_Basic
    {
        public static string WatchDogSetIniFilePath = AppDomain.CurrentDomain.BaseDirectory + "\\System_WatchDog_Basic.ini";//必须要使用完整的文件名
